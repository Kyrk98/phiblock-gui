...
import phiblockComponents.TransactionHistory 1.0
import phiblockComponents.TransactionHistoryModel 1.0
import phiblockComponents.Subaddress 1.0
import phiblockComponents.SubaddressModel 1.0
        ...
        Item {
            ...
            Item {
                ...
                MoneroComponents.TextPlain {
                    ...
                    font.bold: false
                    color: "white"
                    text: "<style type='text/css'>a {text-decoration: none; color: #00ABA0; font-size: 12px;}</style>%1: %2 <a href='#'>(%3)</a>"
...
//                        }
            ...
            Item {
                ...
                ColumnLayout {
                    ...
                    MoneroComponents.TextPlain {
                        ...
                        font.bold: false
                        color: "white"
                        text: qsTr("Amount to receive") + " (PHI)" + translationManager.emptyString
                        themeTransition: false
                    }
                    ...
                    MoneroComponents.TextPlain {
                        // @TODO: When we have PHI/USD rate avi. in the future.
                        visible: false
                        font.pixelSize: 14
                        font.bold: false
                        color: "white"
    ...
    Rectangle {
        ...
        MoneroComponents.TextPlain {
            ...
            font.pixelSize: 14
            font.bold: true
            color: MoneroComponents.Style.phiblockGrey
