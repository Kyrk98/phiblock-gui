...
function getApproximateBlockchainHeight(_date, _nettype){
    // time of phiblock birth 2014-04-18 10:49:53 (1397818193)
    var phiblockBirthTime = _nettype == "Mainnet" ? 1637705268 : _nettype == "Testnet" ? 1637705268 : 1637705268;
    // avg seconds per block in v1
    var secondsPerBlockV1 = 120;
    // time of v2 fork 2016-03-23 15:57:38 (1458748658)
    var forkTime = _nettype == "Mainnet" ? 1637705268 : _nettype == "Testnet" ? 1637705268 : 1637705268;
    // v2 fork block
    ...
    var secondsPerBlock;
    // before phiblock's birth
    if (requestedTime < phiblockBirthTime){
        console.log("Calculated blockchain height: 0, requestedTime < phiblockBirthTime " );
        return 0;
    }
    // time between during v1
    if (requestedTime > phiblockBirthTime && requestedTime < forkTime){
        approxBlockchainHeight = Math.floor((requestedTime - phiblockBirthTime)/secondsPerBlockV1);
